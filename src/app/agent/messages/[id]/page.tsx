...
export default function ChatPage() {
  ...
  useEffect(() => {
    fetch("/api/auth/session")
      ...
      .then((s) => {
        ...
        else router.push("/login?callbackUrl=/agent/messages/" + conversationId);
      });
  ...
  useEffect(() => {
    ...
    fetch(`/api/conversations/${conversationId}`)
      ...
      .catch(() => router.push("/agent/messages"));
  }, [conversationId, router]);
    ...
    <div className="h-screen flex flex-col bg-light">
      ...
      <div className="bg-white border-b border-gray-100 px-4 py-3 flex-shrink-0">
        <div className="flex items-center gap-3">
          <Link href="/agent/messages" className="text-gray-400 hover:text-gray-600 transition flex-shrink-0">
